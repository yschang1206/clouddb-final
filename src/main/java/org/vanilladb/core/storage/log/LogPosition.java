...
public class LogPosition implements Comparable<LogPosition> {
	...
	public static final LogPosition DEFAULT_VALUE = new LogPosition(-1, -1);

	private final long blkNum, offset;
	private final int hashCode;

	public static LogPosition readFromPage(Page page, int pos) {
		...
		return new LogPosition(blkNum, offset);
	}

	public LogPosition(long blkNum, long offset) {
		this.blkNum = blkNum;
		this.offset = offset;
	...
	public boolean equals(Object obj) {
		...
		if (!obj.getClass().equals(LogPosition.class))
			return false;

		LogPosition lsn = (LogPosition) obj;
	...
	@Override
	public int compareTo(LogPosition lsn) {
